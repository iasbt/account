...
if (-not $global:CORS_ALLOWLIST) {
    $global:CORS_ALLOWLIST = "https://account.iasbt.com,https://account.iasbt.com.pages.dnsoe5.com,https://account1-76iej0ca.edgeone.dev,http://119.91.71.30,http://119.91.71.30:5173,https://account-*.vercel.app,http://localhost:5173,http://127.0.0.1:5173"
}
