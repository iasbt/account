...
if (-not $global:ACCOUNT_PUBLIC_URL) { $global:ACCOUNT_PUBLIC_URL = "https://$($global:PRIMARY_DOMAIN)" }
...
if (-not $global:CORS_ALLOWLIST) {
    $global:CORS_ALLOWLIST = "$($global:ACCOUNT_PUBLIC_URL),https://www.$($global:PRIMARY_DOMAIN),https://account.$($global:PRIMARY_DOMAIN),https://account.iasbt.com,http://$($global:DEPLOY_SERVER_IP),https://$($global:DEPLOY_SERVER_IP),http://$($global:DEPLOY_SERVER_IP):5173,https://account-*.vercel.app,http://localhost:5173,http://127.0.0.1:5173"
}
